...
$list = Functions::getLocations();
$select = HtmlHelper::getCountriesList($list['countries']);
$states = json_encode($list['states']);
$player = '$f';
$js = <<<JS
var items = {
    'bundle1': ['Crystal1', '3CD compilation + booklet + digital release'],
    'bundle2': ['Crystal2', '3CD compilation + booklet + T-shirt'],
    'bundle3': ['Crystal3', '3CD compilation + booklet + Backdrop (1x1,5m size)'],
    'bundle4': ['Crystal4', '3CD compilation + booklet + T-shirt + Backdrop (1x1,5m size)'],
    'bundle5': ['Crystal5', '3CD compilation + booklet + T-shirt + Backdrop (1,5x2,25m)'],
    'bundle6': ['Crystal6', '3CD compilation + booklet + T-shirt + Backdrop (2x3m)']
};
...
var plimg = document.getElementById('player-img');
...
<div class="top-digipack center green">
...
<div class="center-digipack">
    <img class="fullsize maxwidth70" src="images/digipack.jpg" />
</div>
...
<div class="cd-top">
    <div class="center">
        <div id="cd1">
            ...
            </div><div class="cd-column"><img class="fullsize" src="images/cd1-min.png"></div>
        </div>
        <div id="cd2">
            <div class="cd-column"><img class="fullsize" src="images/cd2-min.png"></div><div class="cd-column">
                <h4>Part II</h4>
                <svg class="cd-text-svg">
                    <text fill="url(#gradient2)" y="1.1em" x="50%" text-anchor="middle">
                        Endless Glade
        ...
        <div id="cd3">
            ...
            </div><div class="cd-column"><img class="fullsize" src="images/cd3-min.png"></div>
        </div>
    </div>
</div>


<div class="digital-cd center">
    <img class="fullsize" src="images/ball.png">
    <svg class="svg-text2">
        <defs>
...
<div class="album">
    <img class="fullsize center" src="images/album.jpg" style="max-width: 477px" />
</div>

<div id="soundcloud-player">
    <!--<iframe width="100%" style="max-width: 477px" height="477"  class="center" scrolling="no" frameborder="no"
            src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/51894826&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true">
    </iframe>-->
...
<div class="bundles">
    ...
    <div class="bundle b-even">
        <div class="b-wrap">
            ...
            <div class="b-content">
                <svg class="svg-title">
                    <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-title">Crystal 1</text>
                </svg>
                <hr size="1">
                ...
                <div class="price">
                    <svg class="svg-price">
                        <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-price1">30eur</text>
                    </svg>
                    <span id="bundle1-price2">(45eur)</span>
                </div>
    ...
    <div class="bundle b-odd">
        <div class="b-wrap">
            ...
            <div class="b-content">
                <svg class="svg-title">
                    <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-title">Crystal 2</text>
                </svg>
                <hr size="1">
                <p class="b-list">Deluxe edition with the 3CD compilation<br/>
                    <span>Colourful Booklet with the Poem</span><br/>
                ...
                <div class="price">
                    <span id="bundle1-price2">(80eur)</span>
                    <svg class="svg-price">
                        <text fill="url(#gradient1)" y="90%" dx="0" id="bundle2-price1" class="svg-price1">55eur</text>
                    </svg>
                    <span id="bundle1-price2">(80eur)</span>
                </div>
    ...
    <div class="bundle b-even">
        <div class="b-wrap">
            ...
            <div class="b-content">
                <svg class="svg-title">
                    <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-title">Crystal 3</text>
                </svg>
                <hr size="1">
                <p class="b-list">Deluxe edition with the 3CD compilation<br/>
                    <span>Colourful Booklet with the Poem</span><br/>
                ...
                <div class="price">
                    <svg class="svg-price">
                        <text fill="url(#gradient1)" y="90%" dx="0" id="bundle3-price1" class="svg-price1">90eur</text>
                    </svg>
                    <span id="bundle1-price2">(120eur)</span>
                </div>
    ...
    <div class="bundle b-odd">
        <div class="b-wrap">
            ...
            <div class="b-content">
                <svg class="svg-title">
                    <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-title">Crystal 4</text>
                </svg>
                <hr size="1">
                <p class="b-list">Deluxe edition with the 3CD compilation<br/>
                    <span>Colourful Booklet with the Poem</span><br/>
                ...
                <div class="price">
                    <span id="bundle1-price2">(155eur)</span>
                    <svg class="svg-price big">
                        <text fill="url(#gradient1)" y="90%" dx="0" id="bundle4-price1" class="svg-price1">110eur</text>
                    </svg>
                    <span id="bundle1-price2">(155eur)</span>
                </div>
    ...
    <div class="bundle b-even">
        <div class="b-wrap">
            ...
            <div class="b-content">
                <svg class="svg-title">
                    <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-title">Crystal 5</text>
                </svg>
                <hr size="1">
                <p class="b-list">Deluxe edition with the 3CD compilation<br/>
                    <span>Colourful Booklet with the Poem</span><br/>
                ...
                <div class="price">
                    <svg class="svg-price big">
                        <text fill="url(#gradient1)" y="90%" dx="0" id="bundle5-price1" class="svg-price1">110eur</text>
                    </svg>
                    <span id="bundle1-price2">(170eur)</span>
                </div>
    ...
    <div class="bundle b-odd">
        <div class="b-wrap">
            ...
            <div class="b-content">
                <svg class="svg-title">
                    <text fill="url(#gradient1)" y="90%" dx="0" id="bundle1-price1" class="svg-title">Crystal 6</text>
                </svg>
                <hr size="1">
                <p class="b-list">
                ...
                <div class="price">
                    <span id="bundle1-price2">(330eur)</span>
                    <svg class="svg-price big">
                        <text fill="url(#gradient1)" y="90%" dx="0" id="bundle6-price1" class="svg-price1">240eur</text>
                    </svg>
                    <span id="bundle1-price2">(330eur)</span>
                </div>
...
<div class="bottom">
    <p class="contact">With any questions, ideas for cooperation, please contact us by e-mail:<span> adept@globalsect.ru</span></p>
    <p class="poem">
...
<div class="popup" id="popup" style="display:none">
    <div class="popup-content">
        <div id="close">&#10006;</div>
        <div id="paypal-form">
            <h2>The Mystery Of Crystal Worlds</h2>
            <form class="landing-form" action="checkout.php" method="POST">
                <div class="controls">
                ...
                <div class="controls">
                    <label class="comment" for="state">COMMENT</label>
